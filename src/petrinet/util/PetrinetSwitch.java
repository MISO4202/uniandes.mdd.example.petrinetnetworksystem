...
public class PetrinetSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PetrinetPackage.ARC: {
				...
				if (result == null) result = caseElement(arc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetrinetPackage.OUTPUT_ARC: {
				...
				if (result == null) result = caseElement(outputArc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetrinetPackage.INPUT_ARC: {
				...
				if (result == null) result = caseElement(inputArc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case PetrinetPackage.NETWORK_SYSTEM: {
				NetworkSystem networkSystem = (NetworkSystem)theEObject;
				T result = caseNetworkSystem(networkSystem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Network System</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Network System</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNetworkSystem(NetworkSystem object) {
		return null;
	}
